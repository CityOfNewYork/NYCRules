...
<?php  if ($textsize_normal): ?>
  <li class="ts_normal_<?php print check_plain($link_type); ?>"><?php print l('', 'textsize/normal', array('attributes' => array('title' => $block_title .': '. t('') .' ='. $normal .'%', 'class' => 'ts_icon ts_normal_'. $link_type .' textsize_normal text_'. $display_links), 'query' => $dest, 'html' => TRUE)); ?></li>
<?php endif; ?>


<?php  if ($textsize_decrease): ?>
  <li class="ts_decrease_<?php print check_plain($link_type); ?>"><?php print l('', 'textsize/decrease', array('attributes' => array('title' => $block_title .': '. t('') .' -'. $increment .'%', 'class' => 'ts_icon ts_decrease_'. $link_type .' textsize_decrease text_'. $display_links), 'query' => $dest, 'html' => TRUE)); ?></li>
<?php endif; ?>


<?php  if ($textsize_increase): ?>
  <li class="ts_increase_<?php print check_plain($link_type); ?>"><?php print l('', 'textsize/increase', array('attributes' => array('title' => $block_title .': '. t('') .' +'. $increment .'%', 'class' => 'ts_icon ts_increase_'. $link_type .' textsize_increase text_'. $display_links), 'query' => $dest, 'html' => TRUE)); ?></li>
<?php endif; ?>
